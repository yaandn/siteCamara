  ...
  return (
    <>
      ...
      <Container>
        ...
        <Text>
          <p>
            O regimento interno de um órgão público ou instituição é um conjunto
            de normas que estabelece as regras e procedimentos para o
            funcionamento interno da administração da instituição. Ele define as
            atribuições, as formas de organização e o processo de tomada de
          ...
          <p>
            ...
            operacionais e administrativos de um órgão específico, a Lei
            Orgânica tem um caráter mais amplo e estabelece os fundamentos
